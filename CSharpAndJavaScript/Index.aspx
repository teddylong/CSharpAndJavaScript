        ...
        <div id="WholeDiv" style="margin-left: auto; margin-right: auto; width: 1400px;">
            ...
            <div id="DataTableDiv" class="" style="margin-left: 530px; margin-top: -480px; width: 870px;">
                ...
                toolbar:'#tb'">
                    <thead>
                        <tr>
                            <th data-options="field:'caseid',width:70,align:'center'">CaseID</th>
                            <th data-options="field:'name',width:210,align:'center'">Name</th>
                            <th data-options="field:'time',width:170,align:'center'">Time</th>
                            ...
                            <th data-options="field:'platform',width:160,align:'center'">Platform</th>
                        </tr>
                    </thead>
                </table>
